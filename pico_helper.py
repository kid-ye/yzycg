# This is the code running on the Raspberry Pi Pico 2
import machine
import time
import sys
...
while True:
    try:
        ...
        # Pack ECG (Little Endian?) -> Actually code packs it byte by byte
        ...
        # sys.stdout.buffer.flush() # Micropython usually auto-flushes or doesn't have it
        time.sleep(0.008) # approx 125 Hz
